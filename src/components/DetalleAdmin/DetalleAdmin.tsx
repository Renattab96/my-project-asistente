...
const DetalleAdmin = () => {
  ...
  // const isSupport = location.pathname.includes('/support/user-data/:id');
                ...
                <section className="shadow-2xl w-full p-6 bg-white rounded-md text-gray-700">
                  ...
                  <form>
                    <div className="grid grid-cols-1 gap-6 mt-8 sm:grid-cols-2">
                      ...
                      <div>
                        <label className="text-xl text-gray-700" htmlFor="ingreso">
                          Ingreso
                        </label>
                        <input
                          id="ingreso"
                      ...
                      <div>
                        <label className="text-xl text-gray-700" htmlFor="emailAddress">
                          Email
                        </label>
                        <input
                          id="emailAddress"
